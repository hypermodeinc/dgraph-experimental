...
const CodeHighlighter: React.FC<CodeHighlighterProps> = ({ code, language, maxHeight = '400px' }) => {
  ...
  const getStyle = (type: 'container' | 'pre') => {
    const langStyle = styleMap[language as keyof typeof styleMap] || styleMap.default;
  ...
  return (
    <div
      ...
      style={{
        maxHeight,
        background: language === 'graphql' || language === 'dql' ? 'transparent' : '#222',
        color: '#e2e2e2',
        fontFamily:
          'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace',
        ...getStyle('container'),
