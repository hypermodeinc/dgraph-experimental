      ...
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-4">
            The batch you're looking for doesn't exist or may have been removed.
          </p>
        </div>
      </div>
    );
        ...
        <div className="px-6 py-4">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-medium text-white">
              Spreadsheet View - {currentBatch.name}
            </h1>
          </div>
        </div>
      </div>
        ...
        <div className="w-full h-full flex items-center justify-center">
          <div className="bg-[#222] p-6 rounded-lg max-w-md">
            ...
            <h3 className="text-lg font-medium text-white text-center mb-2">
              Multi-File Spreadsheet View
            </h3>
            <p className="text-gray-400 text-center mb-4">
              This feature is under development. Soon you'll be able to view and
              manage spreadsheet data from multiple CSV files.
            </p>
            <div className="p-4 bg-purple-900/20 border border-purple-800/40 rounded-lg">
              <p className="text-purple-300 text-sm">
                The combined view will let you browse and analyze data across
                all files in your batch.
              </p>
            </div>
            <div className="mt-4">
              <p className="text-sm text-gray-400 text-center">
                For now, you can view individual CSV files by clicking on them
                in the batch view.
              </p>
            </div>
          </div>
